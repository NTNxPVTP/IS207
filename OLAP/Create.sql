...
CREATE TABLE DIM_APPLICATION_DATE (
    APPLICATION_DATE_KEY       INT identity(1,1) PRIMARY KEY,     -- YYYYMMDD
...
CREATE TABLE DIM_FRAUD_TYPE (
	FRAUD_TYPE_KEY INT IDENTITY(1,1) PRIMARY KEY,
	FRAUD_TYPE NVARCHAR(500),
	)
...
CREATE TABLE [FACT_LOAN_APPLICATION] (
	...
	CONSTRAINT DATE_FK FOREIGN KEY(APPLICATION_DATE_KEY) 
		REFERENCES DIM_APPLICATION_DATE(APPLICATION_DATE_KEY),
		CONSTRAINT FRAUD_TYPE_FK FOREIGN KEY(FRAUD_TYPE_KEY)
		REFERENCES DIM_FRAUD_TYPE(FRAUD_TYPE_KEY)
)
